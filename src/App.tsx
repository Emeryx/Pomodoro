...
interface TimerDisplay{timerStatus: string, timerType: "Session" | "Break", time: number}
...
function App() {
    ...
    const modifyBreak = (increment: boolean) => {
        if(timerState.timerStatus==="Running") return; // Don't do anything if active, toggleActive(false) may be needed in the future
    ...
    return (
        ...
        <Timer sessionLength={sessionLength*60} breakLength={breakLength*60} timerState={timerState} setTimerState={setTimerState} />
